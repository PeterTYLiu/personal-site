	...
	return (
		<main className={styles.main}>
			<div className={styles.about}>
				...
				<p>
					At <strong>Leap Tools</strong>, I'm building our design system, used
					by dozens of our developers, and customized by hundred of clients,
					including Home Depot, Costco, and Redfin.
				</p>
				<p>
