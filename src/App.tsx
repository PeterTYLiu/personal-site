  ...
  return (
    <main className={styles.main}>
      <div className={styles.about}>
        <p>
          Hi! I'm <strong>Peter Liu</strong>, a full-stack web developer and UI designer living in beautiful Toronto, Canada.
        </p>
        <p>
          At <strong>Leap Tools</strong>, I'm building our design system, used by dozens of our developers, and customized by hundred of
          clients, including Home Depot, Costco, and Redfin.
        </p>
        <p>
          As a UX consultant, I've worked with clients including Samsung and Crate & Barrel to design custom 3D/AR shopping experiences.
        </p>
        <p>
          ...
          <a href="https://developer.threekit.com/reference/treble" target="_blank">
        ...
        <p>
          ...
          . I love TypeScript, cutting-edge CSS, and <a href="https://css-tricks.com/using-the-platform/">using the platform</a>.
        </p>
        <hr />
        <p>
