...
export const data: Item[] = [
  ...
  },
  {
    ...
    description:
      "Sortabase is a collaborative, visual database-building platform for communities",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "Worked on Teledyne DALSA's website, marketing materials, and public communications",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "Worked with clients and internal sales & technical teams to deploy Threekit's technology with superior UX outcomes",
    bulletPoints: [
  ...
  },
  {
    ...
    iconName: "threekit.png",
    description:
      "Designed from scratch the Threekit software platform in coordination with the engineering team",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "3D modelling tool that outputs pure HTML and CSS. Includes a node-based scene graph with property inheritence.",
    endDate: "2023-05-01",
    title: "Toaster",
  ...
  },
  {
    ...
    description:
      "UX challenge to design an application to help newly-arrived refugees find resources in Canada.",
    ...
    endDate: "2019-01-01",
    siteUrl:
      "https://communitech.ca/technews/waterloo-students-snag-top-prizes-at-code-design-to-win.html",
  },
  {
    ...
    iconName: "communitech.png",
    description:
      "UX challenge to design an application to help the elderly better engage with their community.",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "Completed a full-stack in-person web development bootcamp at Carleton University while working full-time at Threekit.",
    location: "Ottawa",
    endDate: "2020-08-01",
  ...
  },
  {
    ...
    position:
      "Bachelor of Environmental Studies, Joint Honours Urban Planning and Economics Co-op",
    description:
      "Completed a joint degree at the University of Waterloo, with several co-op work terms",
    bulletPoints: [
      "President of UW Film Club",
      "Member of UW Quizbowl competitive trivia team",
    ],
    endDate: "2018-12-01",
